...
class _MediterranesnDietViewState extends State<MediterranesnDietView> {
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                SizedBox(
                                                  width: 28,
                                                  height: 28,
                                                  child: Image.asset("assets/images/eaten.png"),
                                                ),
                                                Padding(
                                                  padding:
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(left: 4, bottom: 3),
                                                  child: Text(
                                                    '${(sBalance * widget.animation!.value).toInt()}',
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                                                      fontFamily: FitnessAppTheme.fontName,
                                                      fontWeight: FontWeight.w600,
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                SizedBox(
                                                  width: 28,
                                                  height: 28,
                                                  child: Image.asset("assets/images/burned.png"),
                                                ),
                                                Padding(
                                                  padding:
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(left: 4, bottom: 3),
                                                  child: Text(
                                                    '${(rBalance * widget.animation!.value).toInt()}',
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                                                      fontFamily: FitnessAppTheme.fontName,
                                                      fontWeight: FontWeight.w600,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Text(
                                            '${((rBalance!-sBalance!)! * widget.animation!.value).toInt()}',
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                              fontFamily: FitnessAppTheme.fontName,
  ...
  readOperationsList() async {
    sBalance = await DatabaseHelper().getSTotal();
    rBalance = await DatabaseHelper().getRTotal();
  }
}
